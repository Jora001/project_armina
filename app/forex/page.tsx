  ...
  return (
    <main className="bg-maincolor min-h-screen w-full flex flex-col items-center">
      <div className="flex flex-col lg:flex-row pt-[30px] pb-[30px] justify-evenly bg-maincolor px-5 lg:px-[40px]">
        ...
        />
        <div
          className={`${my_font.className} flex flex-col text-black max-w-full lg:w-[50%] text-[22px] font-light`}
        >
          <span className="text-justify">
            Musik ist eine Weltsprache. Sie reinigt die Seele und gibt Mut und
            Kraft in den unterschiedlichsten Situationen des Lebens. <br />
            <br />
            ...
            schauspielern in einem gemeinsamen Projekt und treten auf der Bühne
            auf. Mit Erfolg: Viele Schüler haben bereits Aufträge von
            professionellen Theatern erhalten. <br />
            <br />
            Zum nächstmöglichsten Zeitpunkt suchen wir Laienmusiker für unser
            Ensemble. Kinder und Jugendliche, Erwachsene und Senioren, die Lust
            haben, an unseren Projekten teilzunehmen, sind herzlich eingeladen.
            Ein Termin für das Vorspiel wird persönlich vereinbart. Bei
            Interesse bitten wir Sie, das Kontaktformular auszufüllen. <br />
            <br />
            <span className="text-justify font-bold text-[22px]">
              Wir freuen uns auf gemeinsame Projekte mit Ihnen. <br /> Vielen
              Dank.
            </span>
          </span>
        </div>
