       ...
       <div className="h-[100vh] absolute inset-0" style={{ backgroundColor: "rgba(42, 46, 57, 0.51)" }}>
        ...
        <img src="/assets/images/group16.png" className="absolute top-[320px] left-[1250px] " />
          <div className="w-[80%] mx-auto flex flex-col gap-[0rem] h-[100%] justify-center">
            ...
            <p className="text-[60px] text-white font-cormorant font-bold">Mezzosopran/Gesangspädagogin</p>
            <p className="text-[20px] text-[#FFFFFF] font-thin font-Karla ">
                ...
                <div>
                  <nav className=" h-[137px] flex">
                     <div className="w-[27%] bg-[#FFFFFF] flex items-center justify-center">
                       <p className="font-Karla text-[20px] text-[#1E2B3B] font-thin">Ziel der Schule <br></br>für Musik </p>
                     </div>
                        <div className="w-[55%] bg-[#1E2B3B] flex items-center justify-center">
                          <p className="font-Karla text-[#FFFFFF] text-[20px] font-thin">
            ...
            <div className="flex-1 bg-[#1E2B3B] text-white flex flex-col justify-center  w-[80%] mx-auto ">
              <div className="flex flex-col items-start w-[80%] mx-auto mt-[50px]">
                  <Image src="/assets/images/image4.svg" alt="image4" width={80} height={84} className="absolute mr-[715px] mb-[370]"/>
                    <p className="text-[33.36px] font-cormorant w-[80%] font-bold mt-[90px]">Armina Aristak</p>
                    <p className="text-[20px] font-Karla w-[100%] font-thin mt-5 whitespace-normal">
...
<div className="h-[125vh] bg-[#EFEBE8]">
  ...
  <p className="font-cormorant text-[20px] text-[#1E2B3B] italic mt-[10px]">Facellus lorem malesuada ligula pulvinar commodo maecenas</p>
  <div className="grid grid-cols-3 gap-3 mt-[2rem]">
    <Image src="/assets/images/rectangle13.svg" alt="rectangle13" width={407} height={613} className="grayscale hover:grayscale-0 transition duration-500 "/>
    <Image src="/assets/images/rectangle14.svg" alt="rectangle14" width={407} height={325} className="grayscale hover:grayscale-0 transition duration-300 "/>
    <Image src="/assets/images/rectangle12.svg" alt="rectangle12" width={415} height={613} className="grayscale hover:grayscale-0 transition duration-500 "/>
    <Image src="/assets/images/rectangle15.svg" alt="rectangle15" width={199} height={277} className="absolute mt-[336px] ml-[427px] grayscale hover:grayscale-0 transition duration-300 " />
    <Image src="/assets/images/rectangle16.svg" alt="rectangle16" width={199} height={277} className="absolute mt-[336px] ml-[635px] grayscale hover:grayscale-0 transition duration-300 "/>
  </div>
  </div>
  <div className="bg-[#EFEBE8] h-[40vh]">
      ...
      <p className="font-cormorant text-[60px] text-[#000000] mt-[80px] ml-[150px] absolute font-medium">Was Unsere Schüler Sagen</p>
      <p className="text-[#1E2B3B] text-[20px] font-cormorant   absolute mt-[110px] ml-[1250px] font-bold border-2 border-[#1E2B3B] px-5 py-2 cursor-pointer hover:shadow-2xl transition-all duration-500 ">Alles sehen</p>
      </div>
      ...
      <div className="container mx-auto grid grid-cols-3 gap-10 justify-center ml-[80px]">
        ...
        <div className="text-left">
          <h2 className="text-[32px] font-bold text-[#1E2B3B] font-cormorant mb-2">Petra Harres</h2>
          <p className="text-[16px] text-[#000000] font-karla font-thin">I searched the Internet for a singing teacher and came acome into Armina - an absolute stroke of luck!!!She has a great, expressive and powerful voice and is a very sensitive, talented teacher. Using examples, it illustrates what can be improved. She always remains patient and calm. Every singing lesson with her is a win and on top of that it's really fun</p>
        </div>


        <div className="text-left">
          <h2 className="text-[32px] font-bold text-[#1E2B3B] font-cormorant mb-2">Meyer Irmgard</h2>
          <p className="text-[16px] text-[#000000] font-karla font-thin ">My daughter gave me singing lessons at Armina's.Armina has a great voice, works with great joy and transmits this joy. Sensitive and competent she teaches singing techniques and practiced them with me, so that after a short time a success could be heard. It was a lot of fun! </p>
        </div>
