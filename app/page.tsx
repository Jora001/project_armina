          ...
          <div className="h-[100vh] bg-[url('/assets/images/image1.svg')] mt-[2vh] bg-cover bg-center relative ">
            ...
            >
              <div className="w-[80%] mx-auto flex flex-col gap-[0rem] h-[100%] justify-center">
                ...
                <p className="md:text-[60px] text-white font-cormorant font-bold">
                ...
                <p className="md:text-[20px] text-[#FFFFFF] font-thin font-Karla ">
                  ...
                  Schüler auf ein<br></br>
                  hohes künstlerisches Niveau zu bringen. Sie bietet Gesangs-,
                  Instrumental- <br></br>
                  und Schauspiel-Unterricht an. Kinder und Jugendliche,
                  Erwachsene und<br></br>
                  ...
                  <div>
                    ...
                    <div className="flex items-center  ">
                      <Image
                        ...
                        className="mt-[30px]"
                      />
                      <p className="ml-9 mt-[30px] m-19 md:text-[24px] font-Karla">
