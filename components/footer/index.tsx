...
export default function Footer(){
    return (<footer className={`${my_font1.className} bg-maincolor flex justify-between items-center border-t border-[#6B6B6B24] h-[300px] pl-[100px] relative border-[#6B6B6B]`}>
        <div className="flex">
            <Logo />
            <div>
