          ...
          {showTerms && (
            ...
            >
              ...
              >
                ...
                <div className="space-y-4 sm:space-y-6 text-gray-800 leading-relaxed text-[14px] sm:text-[16px] md:text-[18px] px-2 sm:px-4">
                  <div className="border-l-4 border-blue-500 pl-3 sm:pl-4">
                    <h3 className="text-[18px] sm:text-[20px] md:text-[22px] font-semibold text-gray-900 mb-2">Impressum</h3>
                    <p>
                      ...
                      E-Mail: andreaDesign@gmail.com <br /><br />
